...
<article class="balance_tabs">
		<h4 class="t-center">Red del hogar</h4>
		<div class="t-center f-size-16">
			<div class="v-pad-s">
				<i class="fab fa-chromecast i-size_4_rem"></i>
			</div>
			<div>
...
<article class="balance_tabs">
		<h4 class="t-center">Teléfono de trabajo</h4>
		<div class="t-center f-size-16">
			<div>
				<div class="v-pad-s">
				<i class="fas fa-mobile-alt i-size_4_rem"></i>
				</div>
...
<article class="balance_tabs">
		<h4 class="t-center">Datos moviles</h4>
		<div class="t-center f-size-16">
			<div class="v-pad-s">
				<i class="fas fa-signal i-size_4_rem"></i>
			</div>
